...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_BATTLERAVOIDEDATTACK]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}には\nあたらなかった!"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{JPN}{B_TRAINER1_NAME_WITH_CLASS}は\n{B_BUFF2}を くりだそうと している\p{B_PLAYER_NAME}も ポケモンを\nいれかえますか?"),
