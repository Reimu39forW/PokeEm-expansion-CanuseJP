    ...
    case FIELD_EFFECT_OVERWORLD_TERRAIN:   // terrain starting from overworld weather
        if (TryGetRandomFrontierLogicalWeather(&randomFrontierWeather))
        {
            ...
            case WEATHER_RAIN_THUNDERSTORM:
                if (B_THUNDERSTORM_TERRAIN == TRUE && gFieldTimers.terrain != B_TERRAIN_ELECTRIC)
                {
            ...
            case WEATHER_FOG_HORIZONTAL:
                if (B_OVERWORLD_FOG >= GEN_8 && gFieldTimers.terrain != B_TERRAIN_MISTY)
                {
            ...
            case WEATHER_FOG:
                ...
                {
                    gFieldTimers.terrain = B_TERRAIN_PSYCHIC;
                    gFieldTimers.terrainTimer = 0;
