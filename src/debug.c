...
static const struct DebugMenuOption sDebugMenu_Actions_TimeMenu[] =
{
    ...
    { COMPOUND_STRING("{JPN}ひがわりを やりなおす"), DebugAction_TimeMenu_RedoDailyEvents },
...
static const struct DebugMenuOption sDebugMenu_Actions_Utilities[] =
{
    ...
    { COMPOUND_STRING("{JPN}マップワープへ とぶ{ENG}..."), DebugAction_Selection_Init, &sWarpSelection },
    { COMPOUND_STRING("{JPN}てんきを かえる{ENG}..."),      DebugAction_Selection_Init, &sSetWeatherSelection },
    ...
    { COMPOUND_STRING("{JPN}しゅぞくランダムを ためす"), DebugAction_Selection_Init, &sSpeciesGeneratorSelection },
    { COMPOUND_STRING("{JPN}どうぐランダムを ためす"), DebugAction_Selection_Init, &sItemGeneratorSelection },
...
{
    { COMPOUND_STRING("{JPN}どうぐを わたす{ENG}..."),    DebugAction_Selection_Init, &sGiveItemSelection },
    ...
    { COMPOUND_STRING("{JPN}タマゴを わたす"),          DebugAction_Selection_Init, &sEggPokemonSelection },
    { COMPOUND_STRING("{JPN}もようがえグッズを わたす{ENG}..."),  DebugAction_Selection_Init, &sGiveDecorationSelection },
...
{
    { COMPOUND_STRING("{JPN}マップないのトレーナー{ENG}..."), DebugAction_Selection_Init, &sTrainerFromMapSelection },
...
{
    [DEBUG_FLAGVAR_MENU_ITEM_FLAGS]                = { COMPOUND_STRING("{JPN}フラグを セット{ENG}..."),                     DebugAction_Selection_Init, &sToggleFlagSelection },
    [DEBUG_FLAGVAR_MENU_ITEM_VARS]                 = { COMPOUND_STRING("{JPN}へんすうを セット{ENG}..."),                      DebugAction_Selection_Init, &sSetVarSelection },
...
static const struct DebugMenuOption sDebugMenu_Actions_Main[] =
{
    ...
    { COMPOUND_STRING("{JPN}エンカウント{ENG}..."),   DebugAction_OpenSubMenu, sDebugMenu_Actions_Encounters, },
