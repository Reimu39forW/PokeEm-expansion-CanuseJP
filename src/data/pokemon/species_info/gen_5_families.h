...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SNIVY] =
    {
        ...
        .categoryName = _("{JPN}くさへび"),
        .height = 6,
        .weight = 81,
        .description = COMPOUND_STRING(
            "{JPN}ちのうが たかく とても れいせい。\nたいようの ひかりを たっぷり\nあびると うごきが するどくなる。"),
        .pokemonScale = 422,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SERPERIOR] =
    {
        ...
        .categoryName = _("{JPN}ロイヤル"),
        .height = 33,
        .weight = 630,
        .description = COMPOUND_STRING(
            "{JPN}にらむだけで あいての うごきを\nとめてしまう。たいようエネルギーを\nたいないで ぞうふくさせる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 405,
        .trainerOffset = 8,
    ...
    [SPECIES_TEPIG] =
    {
        ...
        .categoryName = _("{JPN}ひぶた"),
        .height = 5,
        .weight = 99,
        .description = COMPOUND_STRING(
            "{JPN}てきの こうげきを みがるに よけて\nはなから ひのたまを うちだす。\nほのおで きのみを やいて たべる。"),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .categoryName = _("{JPN}しゅぎょう"),
        .height = 8,
        .weight = 245,
        .description = COMPOUND_STRING(
            "{JPN}ながれるような たちさばきで\n2まいの ホタチを あつかう わざは\nきびしい しゅぎょうによって みにつける。"),
        .pokemonScale = 366,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SAMUROTT_HISUI] =
    {
        ...
        .weight = 582,
        .description = COMPOUND_STRING(
            "{JPN}ひじょうなる きしつと たちすじを ゆうす。\nどとうの れんげきは ちえなみの ごとし。\nヒスイにて しんかせし けうなるすがた。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_PATRAT] =
    {
        ...
        .categoryName = _("{JPN}みはり"),
        .height = 5,
        .weight = 116,
        .description = COMPOUND_STRING(
            "{JPN}ほほの ふくろに エサを ためこみ\nなんにちも みはりを つづける。\nしっぽで なかまに あいずする。"),
        .pokemonScale = 432,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WATCHOG] =
    {
        ...
        .categoryName = _("{JPN}けいかい"),
        .height = 11,
        .weight = 270,
        .description = COMPOUND_STRING(
            "{JPN}ほっぺの ふくろに ためた きのみの\nタネを とばして こうげき。 てきを\nはっけんすると しっぽを たてる。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HERDIER] =
    {
        ...
        .categoryName = _("{JPN}ちゅうけん"),
        .height = 9,
        .weight = 147,
        .description = COMPOUND_STRING(
            "{JPN}マントのように からだを おおう\nくろい たいもうは とても かたい。\nうけた ダメージを へらしてくれる。"),
        .pokemonScale = 338,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STOUTLAND] =
    {
        ...
        .categoryName = _("{JPN}かんだい"),
        .height = 12,
        .weight = 610,
        .description = COMPOUND_STRING(
            "{JPN}ふぶきで とざされた やまに はいり\nそうなんした ひとを たすける。\nながい けが さむさを ふせぐ。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PANSAGE] =
    {
        ...
        .categoryName = _("{JPN}くさざる"),
        .height = 6,
        .weight = 105,
        .description = COMPOUND_STRING(
            "{JPN}ふかい もりで くらす ポケモン。\nあたまに はえた はっぱを たべると\nつかれが うそのように きえる。"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SIMISAGE] =
    {
        ...
        .categoryName = _("{JPN}とげざる"),
        .height = 11,
        .weight = 305,
        .description = COMPOUND_STRING(
            "{JPN}きしょうが はげしく トゲの ついた\nしっぽを ふりまわして たたかう。\nあたまの はっぱは とても にがい。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PANSEAR] =
    {
        ...
        .categoryName = _("{JPN}こうおん"),
        .height = 6,
        .weight = 110,
        .description = COMPOUND_STRING(
            "{JPN}あたまの ふさは おこると おんどが\nあがり 300ど いじょうになる。\nきのみを ふさで やいて たべる。"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PANPOUR] =
    {
        ...
        .categoryName = _("{JPN}みずかけ"),
        .height = 6,
        .weight = 135,
        .description = COMPOUND_STRING(
            "{JPN}あたまの ふさに ためた みずは\nえいよう たっぷり。 しょくぶつに\nかけると おおきく そだつのだ。"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SIMIPOUR] =
    {
        ...
        .categoryName = _("{JPN}ほうすい"),
        .height = 10,
        .weight = 290,
        .description = COMPOUND_STRING(
            "{JPN}あたまの ふさに みずを ためる。\nちょすいりょうが へると しっぽで\nみずを すいあげて ほきゅうする。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .categoryName = _("{JPN}ゆめくい"),
        .height = 6,
        .weight = 233,
        .description = COMPOUND_STRING(
            "{JPN}ムンナに ゆめを たべられてしまうと\nゆめの ないようを わすれてしまう。\nつねに くうちゅうに うかんでいる。"),
        .pokemonScale = 422,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PIDOVE] =
    {
        ...
        .categoryName = _("{JPN}こばと"),
        .height = 3,
        .weight = 21,
        .description = COMPOUND_STRING(
            "{JPN}トレーナーの めいれいを よく きく\nせいかくだが むずかしい しじは\nりかい できない こともある。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_UNFEZANT] =
    {
        ...
        .categoryName = _("{JPN}プライド"),
        .height = 12,
        .weight = 290,
        .description = COMPOUND_STRING(
            "{JPN}オスは あたまの かざりを ゆらして\nあいてを いかくする。 メスの ひこう\nのうりょくは オスを うわまわる。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BLITZLE] =
    {
        ...
        .categoryName = _("{JPN}たいでん"),
        .height = 8,
        .weight = 298,
        .description = COMPOUND_STRING(
            "{JPN}ほうでんすると たてがみが ひかる。\nたてがみの ひかりかたで なかまと\nコミュニケーションを とっている。"),
        .pokemonScale = 366,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ZEBSTRIKA] =
    {
        ...
        .categoryName = _("{JPN}らいでん"),
        .height = 16,
        .weight = 795,
        .description = COMPOUND_STRING(
            "{JPN}いなずまのような しゅんぱつりょく。\nゼブライカが ぜんそくりょくで\nはしると らいめいが ひびきわたる。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_BOLDORE] =
    {
        ...
        .categoryName = _("{JPN}こうせき"),
        .height = 9,
        .weight = 1020,
        .description = COMPOUND_STRING(
            "{JPN}パワーが みなぎると オレンジいろの\nけっしょうが ひかり かがやく。\nほらあなで ちかすいを さがす。"),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GIGALITH] =
    {
        ...
        .categoryName = _("{JPN}こうあつ"),
        .height = 17,
        .weight = 2600,
        .description = COMPOUND_STRING(
            "{JPN}たいないの コアで エネルギーを\nあっしゅくして うちだす こうげきは\nやまを ふきとばす いりょく。"),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .categoryName = _("{JPN}こうもり"),
        .height = 4,
        .weight = 21,
        .description = COMPOUND_STRING(
            "{JPN}くらい もりや ほらあなで くらす。\nはなの あなから ちょうおんぱを だして\nあたりの ようすを さぐる。"),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWOOBAT] =
    {
        ...
        .categoryName = _("{JPN}きゅうあい"),
        .height = 9,
        .weight = 105,
        .description = COMPOUND_STRING(
            "{JPN}いろいろな しゅうはすうの おんぱを\nはなの あなから はっしゃする。\nいわを はかいする おんぱも だす。"),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRILBUR] =
    {
        ...
        .categoryName = _("{JPN}もぐら"),
        .height = 3,
        .weight = 85,
        .description = COMPOUND_STRING(
            "{JPN}ちちゅうを ほりすすむ スピードは\nじそく50キロいじょう。 ちじょうを\nはしる じどうしゃと いいしょうぶ。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TIMBURR] =
    {
        ...
        .categoryName = _("{JPN}きんこつ"),
        .height = 6,
        .weight = 125,
        .description = COMPOUND_STRING(
            "{JPN}かくざいを ふりまわして たたかう。\nおもい かくざいを くも なく\nもつようになると しんかは ちかい。"),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_THROH] =
    {
        ...
        .categoryName = _("{JPN}じゅうどう"),
        .height = 13,
        .weight = 555,
        .description = COMPOUND_STRING(
            "{JPN}おびを しめると パワーアップする。\nやせいの ナゲキは つるくさを あんで\nじぶんの おびを つくる。"),
        .pokemonScale = 272,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SAWK] =
    {
        ...
        .categoryName = _("{JPN}からて"),
        .height = 14,
        .weight = 510,
        .description = COMPOUND_STRING(
            "{JPN}ダゲキが しゅぎょうする やまから\nおおいわや たいぼくに こぶしを\nうちつける おとが きこえてくる。"),
        .pokemonScale = 265,
        .pokemonOffset = 4,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_SEWADDLE] =
    {
        ...
        .categoryName = _("{JPN}さいほう"),
        .height = 3,
        .weight = 25,
        .description = COMPOUND_STRING(
            "{JPN}タマゴから かえると ハハコモリに\nふくを つくってもらい きせられる。\nフードで あたまを かくして ねる。"),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        .categoryName = _("{JPN}はごもり"),
        .height = 5,
        .weight = 73,
        .description = COMPOUND_STRING(
            "{JPN}クルマユの すむ もりは くさきが\nよく そだつ。クルマユが おちばを\nえいようぶんに かえているのだ。"),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEAVANNY] =
    {
        ...
        .categoryName = _("{JPN}こそだて"),
        .height = 12,
        .weight = 205,
        .description = COMPOUND_STRING(
            "{JPN}ちいさい ポケモンを みつけると\nうでの カッターと ねんちゃくいとで\nはっぱの ふくを ぬう しゅうせい。"),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VENIPEDE] =
    {
        ...
        .categoryName = _("{JPN}ムカデ"),
        .height = 4,
        .weight = 53,
        .description = COMPOUND_STRING(
            "{JPN}かみついて もうどくを あたえる。\nてんてきの おおきな とりポケモンも\nからだが しびれて うごけなくなる。"),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCOLIPEDE] =
    {
        ...
        .categoryName = _("{JPN}メガムカデ"),
        .height = 25,
        .weight = 2005,
        .description = COMPOUND_STRING(
            "{JPN}すばやい うごきで てきを おいつめ\nあたまの ツノで こうげきする。\nとどめを さすまで ようしゃしない。"),
        .pokemonScale = 257,
        .pokemonOffset = 2,
        .trainerScale = 423,
        .trainerOffset = 8,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_COTTONEE] =
    {
        ...
        .categoryName = _("{JPN}わたたま"),
        .height = 3,
        .weight = 6,
        .description = COMPOUND_STRING(
            "{JPN}おそわれると からだから わたを とばす。\nてきが わたを モンメンと\nまちがえている すきに にげるのだ。"),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LILLIGANT_HISUI] =
    {
        ...
        .cryId = CRY_LILLIGANT,
        .natDexNum = NATIONAL_DEX_LILLIGANT,
        .categoryName = _("{JPN}スピン"),
        .height = 12,
        .weight = 192,
        .description = COMPOUND_STRING(
            "{JPN}ゆきふかきやまに すみしゆえに きゃくりょくが\nはったつしたと こうさつす。 しゅういのものを\nこぶする かおりを かんむりのはなより はなつ。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] =
    {
        ...
        .cryId = CRY_BASCULIN,
        .natDexNum = NATIONAL_DEX_BASCULIN,
        .categoryName = _("{JPN}おんこう"),
        .height = 10,
        .weight = 180,
        .description = COMPOUND_STRING(
            "{JPN}ごっかんの うみで むれを つくり\nエサを わけあって くらす。 ときが\nくると うまれた かわに かえる。"),
        .pokemonScale = 316,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_BASCULEGION_M] =
    {
        ...
        .categoryName = _("{JPN}おおうお"),
        .height = 30,
        .weight = 1100,
        .description = COMPOUND_STRING(
            "{JPN}すさまじい ジャンプりょくを もつ。\nしんでいった なかまたちの いかりが\nからだを あかく そめあげている。"),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SANDILE] =
    {
        ...
        .categoryName = _("{JPN}さばくワニ"),
        .height = 7,
        .weight = 152,
        .description = COMPOUND_STRING(
            "{JPN}さばくの すなの なかで せいかつ。\nたいように あたためられた すなが\nたいおんの ていかを ふせぐのだ。"),
        .pokemonScale = 365,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        .categoryName = _("{JPN}だるま"),
        .height = 6,
        .weight = 375,
        .description = COMPOUND_STRING(
            "{JPN}たいないで ほのおが もえていると\nおちつかなく はしりまわっている。\nほのおが ちいさくなると ねむる。"),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DARMANITAN_STANDARD] =
    {
        ...
        .categoryName = _("{JPN}えんじょう"),
        .height = 13,
        .weight = 929,
        .description = COMPOUND_STRING(
            "{JPN}たいないで 1400どの ほのおを\nもやすことで ダンプカーを パンチで\nはかいするほどの パワーを つくる。"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .categoryName = _("{JPN}いしやど"),
        .height = 3,
        .weight = 145,
        .description = COMPOUND_STRING(
            "{JPN}いしを とかす えきたいを くちから\nぶんぴつするので かたい いしでも\nかんたんに あなを あけられるのだ。"),
        .pokemonScale = 530,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CRUSTLE] =
    {
        ...
        .categoryName = _("{JPN}いわやど"),
        .height = 14,
        .weight = 2000,
        .description = COMPOUND_STRING(
            "{JPN}なわばりを とりあって イワパレス\nどうしが はげしく たたかう。\nいわを こわされた ほうが まけ。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        .categoryName = _("{JPN}だっぴ"),
        .height = 6,
        .weight = 118,
        .description = COMPOUND_STRING(
            "{JPN}かわを くびまで ひきあげて\nぼうぎょの しせい。ゴムのような だんりょくで\nダメージを へらす。"),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCRAFTY] =
    {
        ...
        .categoryName = _("{JPN}あくとう"),
        .height = 11,
        .weight = 300,
        .description = COMPOUND_STRING(
            "{JPN}なわばりに はいってきた あいてを\nしゅうだんで たたきのめす。\nくちから さんせいの たいえきを とばす。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SIGILYPH] =
    {
        ...
        .categoryName = _("{JPN}とりもどき"),
        .height = 14,
        .weight = 140,
        .description = COMPOUND_STRING(
            "{JPN}こだいとしを まもっていた きおくを\nのこしているため いつも おなじ\nルートを とんでいるらしい。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_YAMASK] =
    {
        ...
        .categoryName = _("{JPN}たましい"),
        .height = 5,
        .weight = 15,
        .description = COMPOUND_STRING(
            "{JPN}もっている マスクは デスマスが\nにんげんだった ときの かお。\nたまに みつめては ないている。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_COFAGRIGUS] =
    {
        ...
        .categoryName = _("{JPN}かんおけ"),
        .height = 17,
        .weight = 765,
        .description = COMPOUND_STRING(
            "{JPN}ちかづいた にんげんを のみこんで\nミイラに してしまうという ウワサ。\nきんかいを このんで たべる。"),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_RUNERIGUS] =
    {
        ...
        .categoryName = _("{JPN}おんねん"),
        .height = 16,
        .weight = 666,
        .description = COMPOUND_STRING(
            "{JPN}つよい のろいを こめて かかれた\nこだいの えが デスマスの\nたましいを とりこみ うごきだした。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_TIRTOUGA] =
    {
        ...
        .categoryName = _("{JPN}こだいがめ"),
        .height = 7,
        .weight = 165,
        .description = COMPOUND_STRING(
            "{JPN}こだいの カセキから ふっかつした。\nふかさ 1000メートルまで\nせんすいすることが できる。"),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARCHEN] =
    {
        ...
        .categoryName = _("{JPN}さいこどり"),
        .height = 5,
        .weight = 95,
        .description = COMPOUND_STRING(
            "{JPN}とりポケモンの そせんと いわれる。\nとぶことは できず えだから えだへ\nとびうつり せいかつしていたらしい。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GARBODOR] =
    {
        ...
        .categoryName = _("{JPN}ゴミすてば"),
        .height = 19,
        .weight = 1073,
        .description = COMPOUND_STRING(
            "{JPN}ひだりうでで あいてを しめつけて\nくちから はきだす あくしゅうの どくガスで\nとどめを さすのだ。"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_ZORUA] =
    {
        ...
        .categoryName = _("{JPN}わるぎつね"),
        .height = 7,
        .weight = 125,
        .description = COMPOUND_STRING(
            "{JPN}あいての すがたに ばけてみせて\nおどろかせる。むくちな こどもに\nばけている ことが おおいらしい。"),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ZOROARK] =
    {
        ...
        .categoryName = _("{JPN}ばけぎつね"),
        .height = 16,
        .weight = 811,
        .description = COMPOUND_STRING(
            "{JPN}あいてを ばかす ことで むれの\nあんぜんを まもってきた ポケモン。\nなかまどうしの けっそくが かたい。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_ZORUA_HISUI] =
    {
        ...
        .cryId = CRY_ZORUA,
        .natDexNum = NATIONAL_DEX_ZORUA,
        .categoryName = _("{JPN}うらみぎつね"),
        .height = 7,
        .weight = 125,
        .description = COMPOUND_STRING(
            "{JPN}ししたたましい ヒスイのちにて よみがえる。\nおんさは ちからとなり あたまより たちのぼり\nあいてのすがたに へんじ うらみ はらしたり。"),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ZOROARK_HISUI] =
    {
        ...
        .cryId = CRY_ZOROARK,
        .natDexNum = NATIONAL_DEX_ZOROARK,
        .categoryName = _("{JPN}のろいぎつね"),
        .height = 16,
        .weight = 730,
        .description = COMPOUND_STRING(
            "{JPN}はくはつ ふりみだしすがた しにがみのごとく。\nわがみをも きりさく はげしきおんしゅうにて\nあだ おそい みちづれかくごで しとめたり。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_CINCCINO] =
    {
        ...
        .categoryName = _("{JPN}スカーフ"),
        .height = 5,
        .weight = 75,
        .description = COMPOUND_STRING(
            "{JPN}しろい たいもうは とくべつな あぶらで\nコーティングされているので\nてきの こうげきを うけながすのだ。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOTHITELLE] =
    {
        ...
        .categoryName = _("{JPN}てんたい"),
        .height = 15,
        .weight = 440,
        .description = COMPOUND_STRING(
            "{JPN}きょうりょくな サイコパワーの えいきょうで\nゴチルゼルの しゅういの くうかんが ねじれ\nなんまんこうねんも とおくの ほしぞらが うつるのだ。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_DUOSION] =
    {
        ...
        .categoryName = _("{JPN}ぶんかつ"),
        .height = 6,
        .weight = 80,
        .description = COMPOUND_STRING(
            "{JPN}2つに ぶんれつした のうみそを\nもっているため いきなり ちがう\nこうどうを とることが あるのだ。"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_REUNICLUS] =
    {
        ...
        .categoryName = _("{JPN}ぞうふく"),
        .height = 10,
        .weight = 201,
        .description = COMPOUND_STRING(
            "{JPN}ランクルス どうしが あくしゅすると\nのうみそが ネットワークで つながり\nサイコパワーが ぞうふくされるのだ。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SWANNA] =
    {
        ...
        .categoryName = _("{JPN}しらどり"),
        .height = 13,
        .weight = 242,
        .description = COMPOUND_STRING(
            "{JPN}よあけと ともに スワンナたちは\nおどりはじめる。まんなかで おどる\nスワンナが むれの リーダー。"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLISH] =
    {
        ...
        .categoryName = _("{JPN}ひょうせつ"),
        .height = 11,
        .weight = 410,
        .description = COMPOUND_STRING(
            "{JPN}ゆきやまに せいそくする ポケモン。\nおおむかし ひょうがきの ときに\nみなみの とちに いどうしてきた。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        .categoryName = _("{JPN}ブリザード"),
        .height = 13,
        .weight = 575,
        .description = COMPOUND_STRING(
            "{JPN}みずを たいりょうに のみこんで\nたいないで ゆきぐもを つくる。\nもうふぶきで てきを くるしめる。"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DEERLING_SPRING] =
    {
        ...
        .categoryName = _("{JPN}きせつ"),
        .height = 6,
        .weight = 195,
        .description = COMPOUND_STRING(
            "{JPN}たいもうが のやまの くさと\nおなじ いろと かおりに かわる。\nてきいを かんじると くさむらに かくれる。"),
        .pokemonScale = 422,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EMOLGA] =
    {
        ...
        .categoryName = _("{JPN}モモンガ"),
        .height = 4,
        .weight = 50,
        .description = COMPOUND_STRING(
            "{JPN}ほほの でんきふくろで つくった でんきを\nまくの うちがわに ためて\nかっくうしながら でんきを はなつ。"),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KARRABLAST] =
    {
        ...
        .categoryName = _("{JPN}かぶりつき"),
        .height = 5,
        .weight = 59,
        .description = COMPOUND_STRING(
            "{JPN}チョボマキと いっしょに いるときに\nでんきてきな しげきを うけると\nしんかする ふしぎな ポケモンだ。"),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ESCAVALIER] =
    {
        ...
        .categoryName = _("{JPN}きへい"),
        .height = 10,
        .weight = 330,
        .description = COMPOUND_STRING(
            "{JPN}こうそくで とびまわり するどい やりで\nあいてを つく。ふりな あいてにも\nゆうかんに たちむかう。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_JELLICENT] =
    {
        ...
        .weight = 1350,
        .description = COMPOUND_STRING(
            "{JPN}ブルンゲルの すみかに まよいこんだ\nふねは しずめられて のりくみいんの いのちは\nすいとられて しまうのだ。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_GALVANTULA] =
    {
        ...
        .categoryName = _("{JPN}でんきグモ"),
        .height = 8,
        .weight = 143,
        .description = COMPOUND_STRING(
            "{JPN}てきに おそわれると でんきを おびびた\nいとを たくさん はきだして\nでんきの バリアを つくる。"),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_FERROTHORN] =
    {
        ...
        .categoryName = _("{JPN}とげだま"),
        .height = 10,
        .weight = 1100,
        .description = COMPOUND_STRING(
            "{JPN}3ぼんの トゲつき しょくしゅを ふりまわして\nたたかう。はがねの トゲは たたきつけると\nおおいわを ふんさいする はかいりょくだ。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .categoryName = _("{JPN}でんきうお"),
        .height = 2,
        .weight = 3,
        .description = COMPOUND_STRING(
            "{JPN}1ぴきの でんりょくは ちいさいが\nたくさんの シビシラスが つながると\nカミナリと おなじ いりょくになる。"),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ELGYEM] =
    {
        ...
        .categoryName = _("{JPN}ブレイン"),
        .height = 5,
        .weight = 90,
        .description = COMPOUND_STRING(
            "{JPN}きょうりょくな サイコパワーを あやつる。\nサイコパワーで あいての のうみそを\nしめつけて ずつうを おこさせる。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LAMPENT] =
    {
        ...
        .categoryName = _("{JPN}ランプ"),
        .height = 6,
        .weight = 130,
        .description = COMPOUND_STRING(
            "{JPN}ふきつな ポケモンと こわがられる。\nししゃの たましいを もとめて\nまちなかを フラフラと さまよう。"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AXEW] =
    {
        ...
        .categoryName = _("{JPN}キバ"),
        .height = 6,
        .weight = 180,
        .description = COMPOUND_STRING(
            "{JPN}きのみを キバで くだいて たべる。\nなんかいも はえかわることで\nつよく するどい キバに なる。"),
        .pokemonScale = 422,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FRAXURE] =
    {
        ...
        .categoryName = _("{JPN}あごオノ"),
        .height = 10,
        .weight = 360,
        .description = COMPOUND_STRING(
            "{JPN}おれた キバは はえかわらないので\nたたかいが おわると かわらの いわで\nキバを たんねんに みがく。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_CUBCHOO] =
    {
        ...
        .categoryName = _("{JPN}ひょうけつ"),
        .height = 5,
        .weight = 85,
        .description = COMPOUND_STRING(
            "{JPN}ぐあいが わるくなると\nはなみずが みずっぽくなり こおりわざの\nいりょくが おちてしまうのだ。"),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BEARTIC] =
    {
        ...
        .categoryName = _("{JPN}とうけつ"),
        .height = 26,
        .weight = 2600,
        .description = COMPOUND_STRING(
            "{JPN}はく いきを じざいに こおらせる。\nおよぎが とくいで きたの うみを\nおよぎまわり えものを つかまえる。"),
        .pokemonScale = 266,
        .pokemonOffset = 3,
        .trainerScale = 399,
        .trainerOffset = 4,
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .categoryName = _("{JPN}けっしょう"),
        .height = 11,
        .weight = 1480,
        .description = COMPOUND_STRING(
            "{JPN}たいおんが あがると すいじょうきに なって\nすがたを けす。たいおんが さがると\nもとの こおりに もどる。"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        .categoryName = _("{JPN}からぬけ"),
        .height = 8,
        .weight = 253,
        .description = COMPOUND_STRING(
            "{JPN}からだが かわくと よわってしまう。\nうすい まくを なんじゅうも まいて\nかんそうを ふせいでいるのだ。"),
        .pokemonScale = 366,
        .pokemonOffset = 9,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_STUNFISK] =
    {
        ...
        .categoryName = _("{JPN}トラップ"),
        .height = 7,
        .weight = 110,
        .description = COMPOUND_STRING(
            "{JPN}ひふが かたいので\nすもうとりに ふまれても へいき。\nでんきを ながすとき わらいがおに なる。"),
        .pokemonScale = 365,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MIENFOO] =
    {
        ...
        .categoryName = _("{JPN}ぶじゅつ"),
        .height = 9,
        .weight = 200,
        .description = COMPOUND_STRING(
            "{JPN}ながれるような れんぞく こうげきを\nくりだして てきを あっとうする。\nするどい ツメで てきを きりさく。"),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOLETT] =
    {
        ...
        .categoryName = _("{JPN}ゴーレム"),
        .height = 10,
        .weight = 920,
        .description = COMPOUND_STRING(
            "{JPN}たいないで もえる エネルギーに よって\nかつどうしているが どんな\nエネルギーなのかは ふめいである。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .categoryName = _("{JPN}とうじん"),
        .height = 16,
        .weight = 700,
        .description = COMPOUND_STRING(
            "{JPN}コマタナの むれを ひきいている。\nボスの ざを うばいあい たたかう。\nやぶれると むれを おいだされる。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_KINGAMBIT] =
    {
        ...
        .categoryName = _("{JPN}だいとう"),
        .height = 20,
        .weight = 1200,
        .description = COMPOUND_STRING(
            "{JPN}だいぐんぜいを ひきいて たたかうが\nむずかしい さくせんは にがてなので\nちからで おして おしまくるだけ。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BOUFFALANT] =
    {
        ...
        .categoryName = _("{JPN}ずつきうし"),
        .height = 16,
        .weight = 946,
        .description = COMPOUND_STRING(
            "{JPN}はげしい ずつきを くらわせても\nふさふさの たいもうが\nダメージを きゅうしゅうして くれるのだ。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .categoryName = _("{JPN}ヒナわし"),
        .height = 5,
        .weight = 105,
        .description = COMPOUND_STRING(
            "{JPN}きゃくりょくで きのみを くだく。\nどんなに つよい あいてでも\nゆうかんに たちむかう しゅうせい。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        .categoryName = _("{JPN}ゆうもう"),
        .height = 15,
        .weight = 410,
        .description = COMPOUND_STRING(
            "{JPN}なかまのため きけんを かえりみず\nたたかう。じてんしゃを つかんだまま\nおおぞらを まう ことが できる。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAVIARY_HISUI] =
    {
        ...
        .cryId = CRY_BRAVIARY,
        .natDexNum = NATIONAL_DEX_BRAVIARY,
        .categoryName = _("{JPN}おたけび"),
        .height = 17,
        .weight = 434,
        .description = COMPOUND_STRING(
            "{JPN}ききせまる ときのこえを あげ かりをする\nたけき おおとり。 こすいに しょうげきはを はなち\nすいめんに うかびし えものを とる。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_VULLABY] =
    {
        ...
        .categoryName = _("{JPN}おむつ"),
        .height = 5,
        .weight = 90,
        .description = COMPOUND_STRING(
            "{JPN}つばさが ちいさいため とべない。\nしんかの ときが ちかづくと\nじぶんから ガイコツを ぬぎすてる。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANDIBUZZ] =
    {
        ...
        .categoryName = _("{JPN}ほねわし"),
        .height = 12,
        .weight = 395,
        .description = COMPOUND_STRING(
            "{JPN}ほねを ひろい あつめて すづくり。\nよわった えものを あしで つかみ\nほねの すまで かるがると はこぶ。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .categoryName = _("{JPN}アリクイ"),
        .height = 14,
        .weight = 580,
        .description = COMPOUND_STRING(
            "{JPN}しっぽの あなから くうきを すって\nたいないで ほのおを もやす。\nアイアントの てんてき。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_DEINO] =
    {
        ...
        .categoryName = _("{JPN}そぼう"),
        .height = 8,
        .weight = 173,
        .description = COMPOUND_STRING(
            "{JPN}なんにでも かみつく しゅうせい。\nたべられるものは なんでも たべる。\nうかつに ちかよると きけんだ。"),
        .pokemonScale = 366,
        .pokemonOffset = 12,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .weight = 1600,
        .description = COMPOUND_STRING(
            "{JPN}6まいの はねで そらを とびつづけ\nうごくものを てきと おもいこみ おそう\nきょうぼうな ポケモン。"),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_LARVESTA] =
    {
        ...
        .categoryName = _("{JPN}たいまつ"),
        .height = 11,
        .weight = 288,
        .description = COMPOUND_STRING(
            "{JPN}たいようから うまれた ポケモンと\nしんじられてきた。しんかするとき\nぜんしんが ほのおに つつまれる。"),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VOLCARONA] =
    {
        ...
        .categoryName = _("{JPN}たいよう"),
        .height = 16,
        .weight = 460,
        .description = COMPOUND_STRING(
            "{JPN}かざんばいで ちじょうが まっくらに\nなったとき ウルガモスの ほのおが\nたいようの かわりに なったという。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
    ...
    [SPECIES_COBALION] =
    {
        ...
        .categoryName = _("{JPN}てっしん"),
        .height = 21,
        .weight = 2500,
        .description = COMPOUND_STRING(
            "{JPN}ポケモンを まもるため にんげんと\nあらそった でんせつの ポケモン。\nちんちゃく れいせいな せいかく。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    [SPECIES_TERRAKION] =
    {
        ...
        .categoryName = _("{JPN}がんくつ"),
        .height = 19,
        .weight = 2600,
        .description = COMPOUND_STRING(
            "{JPN}にんげん どうしの せんそうによって\nすみかを うしなった ポケモンたちを\nまもるため にんげんと たたかった。"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 336,
        .trainerOffset = 4,
    ...
    [SPECIES_VIRIZION] =
    {
        ...
        .categoryName = _("{JPN}そうげん"),
        .height = 20,
        .weight = 2000,
        .description = COMPOUND_STRING(
            "{JPN}なかまを まもるため にんげんに\nたたかいを いどんだ ポケモン。\nでんせつで かたりつがれている。"),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 344,
        .trainerOffset = 4,
    ...
    [SPECIES_THUNDURUS_INCARNATE] =
    {
        ...
        .categoryName = _("{JPN}らいげき"),
        .height = 15,
        .weight = 610,
        .description = COMPOUND_STRING(
            "{JPN}ボルトロスが とおりすぎた とちには\nかみなりの おちた むすうの あとが\nやけこげとなって のこっている。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_RESHIRAM] =
    {
        ...
        .categoryName = _("{JPN}はくよう"),
        .height = 32,
        .weight = 3300,
        .description = COMPOUND_STRING(
            "{JPN}しんわに とうじょうする ポケモン。\nしっぽから ほのおを ふきあげて\nすべての ものを やきつくす。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 445,
        .trainerOffset = 8,
    ...
    [SPECIES_LANDORUS_INCARNATE] =
    {
        ...
        .categoryName = _("{JPN}ほうじょう"),
        .height = 15,
        .weight = 680,
        .description = COMPOUND_STRING(
            "{JPN}ランドロスが おとずれる とちは\nさくもつが たくさん みのるため\nはたけのかみさま と いわれている。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_KYUREM] =
    {
        ...
        .categoryName = _("{JPN}きょうかい"),
        .height = 30,
        .weight = 3250,
        .description = COMPOUND_STRING(
            "{JPN}きょうりょくな れいとうエネルギーを\nたいないで つくりだすが もれだした\nれいきで からだが こおっている。"),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 356,
        .trainerOffset = 0,
    ...
    [SPECIES_KELDEO_ORDINARY] =
    {
        ...
        .categoryName = _("{JPN}わかごま"),
        .height = 14,
        .weight = 485,
        .description = COMPOUND_STRING(
            "{JPN}ひづめから みずを ふきだすことで\nすいめんを すべるように いどう。\nとくいの あしわざで たたかう。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_MELOETTA_ARIA] =
    {
        ...
        .categoryName = _("{JPN}せんりつ"),
        .height = 6,
        .weight = 65,
        .description = COMPOUND_STRING(
            "{JPN}とくしゅな はっせいほうで うたう\nメロディは きいた ものの\nかんじょうを じざいに あやつる。"),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
