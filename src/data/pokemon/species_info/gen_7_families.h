...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DECIDUEYE] =
    {
        ...
        .categoryName = _("{JPN}やばね"),
        .height = 16,
        .weight = 366,
        .description = COMPOUND_STRING(
            "{JPN}わずか 0{ENG}.1びょうで ハネを\nつがえて てきを うつ。 まばたきの\nあいだに しょうぶが ついている。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 296,
        .trainerOffset = 1,
