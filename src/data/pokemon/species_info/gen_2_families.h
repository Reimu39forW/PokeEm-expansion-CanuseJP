...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .categoryName =  _("{JPN}はっぱ"),
        .height = 9,
        .weight = 64,
        .description = COMPOUND_STRING(
            "{JPN}はっぱを ふりまわして あいてを いかくするが\nはっぱから あまい かおりが ただようので\nおたがいに なごやかな ふんいきに なるよ。"),
        .pokemonScale = 512,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .categoryName =  _("{JPN}ハーブ"),
        .height = 18,
        .weight = 1005,
        .description = COMPOUND_STRING(
            "{JPN}はなの かおりは きもちを おだやかにする。\nたたかいの ときは かおりを はっさんさせて\nあいての たたかう きもちを にぶらせるのだ。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 277,
        .trainerOffset = 1,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .categoryName =  _("{JPN}ひねずみ"),
        .height = 5,
        .weight = 79,
        .description = COMPOUND_STRING(
            "{JPN}せなかから ほのおを ふきあげて みを まもる。\nおこった ときの ほのおは いきおいが いいが\nつかれている ときは ふかんぜんねんしょうする。"),
        .pokemonScale = 539,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .categoryName =  _("{JPN}かざん"),
        .height = 9,
        .weight = 190,
        .description = COMPOUND_STRING(
            "{JPN}ほのおの いきおいと ねっぷうで いかくする。\nすばやい みのこなしで あいての こうげきを\nかわしながら どうじに ほのおで もやす。"),
        .pokemonScale = 329,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .categoryName =  _("{JPN}おおあご"),
        .height = 6,
        .weight = 95,
        .description = COMPOUND_STRING(
            "{JPN}ちいさな からだでも アゴの ちからは つよい。\nワニノコじしんは あまがみ している つもりでも\nおおけがを してしまう ほどの ちからが ある。"),
        .pokemonScale = 487,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    #endif // P_MODIFIED_MEGA_CRIES
        .natDexNum = NATIONAL_DEX_FERALIGATR,
        .categoryName =  _("{JPN}にじゅうあご"),
        .height = 23,
        .weight = 1088,
        .description = COMPOUND_STRING(
            "{JPN}フードのような ヒレと りょううでで\nきょだいな あごを つくり かみつく\nいりょくは 10ばい アップした。"),
    ...
    [SPECIES_FURRET] =
    {
        ...
        .categoryName =  _("{JPN}どうなが"),
        .height = 18,
        .weight = 325,
        .description = COMPOUND_STRING(
            "{JPN}てきに おそわれても ほそい すきまに\nするりと もぐりこんで にげる ことが できる。\nてあしは みじかいが とても すばしっこい。"),
        .pokemonScale = 346,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .categoryName =  _("{JPN}ふくろう"),
        .height = 7,
        .weight = 212,
        .description = COMPOUND_STRING(
            "{JPN}からだの なかには ちきゅうの じてんを\nかんじとる きかんを もっているので まいにち\nおなじ じかんに なると なきごえを あげる。"),
        .pokemonScale = 380,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .categoryName =  _("{JPN}いつつぼし"),
        .height = 10,
        .weight = 108,
        .description = COMPOUND_STRING(
            "{JPN}あしの つけねから だす えきたいの においで\nなかまと コミュニケーションを とっている。\nにおいの ちがいで きもちを つたえるという。"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .categoryName =  _("{JPN}いとはき"),
        .height = 5,
        .weight = 85,
        .description = COMPOUND_STRING(
            "{JPN}いとで つくった ワナは だい2の しんけい。\nいとを つたわる わずかな しんどう だけで\nえものの しゅるいが わかると いわれている。"),
        .pokemonScale = 414,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .categoryName =  _("{JPN}あしなが"),
        .height = 11,
        .weight = 335,
        .description = COMPOUND_STRING(
            "{JPN}あしの せんたんには ちいさな カギヅメが あり\nてんじょうや すいちょくの かべも あるける。\nほそく じょうぶな いとで てきを しめあげる。"),
        .pokemonScale = 316,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .categoryName =  _("{JPN}あんこう"),
        .height = 5,
        .weight = 120,
        .description = COMPOUND_STRING(
            "{JPN}きけんを さっちすると 2ほんの しょくしゅから\nプラスと マイナスの でんきを ながす。\nひかりの とどかない かいていで くらす。"),
        .pokemonScale = 424,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .categoryName =  _("{JPN}ライト"),
        .height = 12,
        .weight = 225,
        .description = COMPOUND_STRING(
            "{JPN}つよい ひかりを だす まるい ぶぶんは\nせびれの いちぶが へんかして できたもの。\nしんかいの やみを てらす ポケモン。"),
        .pokemonScale = 269,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .categoryName =  _("{JPN}はりたま"),
        .height = 3,
        .weight = 15,
        .description = COMPOUND_STRING(
            "{JPN}ひとや ポケモンが はっしている やさしさや\nたのしい きもちを エネルギーに している。\nカラの なかに ためた しあわせを わけている。"),
        .pokemonScale = 507,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .categoryName =  _("{JPN}しあわせ"),
        .height = 6,
        .weight = 32,
        .description = COMPOUND_STRING(
            "{JPN}こううんを もたらす ポケモンと いわれている。\nじゅんすいな こころの もちぬしを みつけると\nすがたを あらわし しあわせを わけあたえる。"),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .categoryName =  _("{JPN}わたげ"),
        .height = 6,
        .weight = 78,
        .description = COMPOUND_STRING(
            "{JPN}たいもうが こすれて せいでんきが たまる。\nでんりょくが たくさん たまるほど しっぽの\nさきに ついた でんきゅうが あかるく ひかる。"),
        .pokemonScale = 379,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .categoryName =  _("{JPN}みずたま"),
        .height = 2,
        .weight = 20,
        .description = COMPOUND_STRING(
            "{JPN}えいようが たっぷり つまった しっぽは\nゴムボール みたいに よく はずむ。\nはれた ひは みずべに あつまり みずあそび。"),
        .pokemonScale = 603,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .categoryName =  _("{JPN}みずねずみ"),
        .height = 4,
        .weight = 85,
        .description = COMPOUND_STRING(
            "{JPN}みずを はじく たいもうに おおわれているので\nすいちゅうで みずの ていこうを うけずに\nはやい スピードで およぐ ことが できる。"),
        .pokemonScale = 476,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .categoryName =  _("{JPN}みずうさぎ"),
        .height = 8,
        .weight = 285,
        .description = COMPOUND_STRING(
            "{JPN}1にちの ほとんどを みずの なかで くらす。\nからだの いろと もようは すいちゅうで\nてきに みつかり にくくする カムフラージュ。"),
        .pokemonScale = 448,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .categoryName =  _("{JPN}まね"),
        .height = 12,
        .weight = 380,
        .description = COMPOUND_STRING(
            "{JPN}てきに おそわれない ように きの ふりをする。\nりょうては 1ねんじゅう みどりいろなので\nふゆは にせものだと すぐに ばれてしまう。"),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .categoryName =  _("{JPN}わたくさ"),
        .height = 4,
        .weight = 5,
        .description = COMPOUND_STRING(
            "{JPN}かぜに のって ふわふわ ただよう ポケモン。\nきょうふうの けはいを かんじると なかまどうし\nはっぱを からめ とばされない じゅんびをする。"),
        .pokemonScale = 562,
        .pokemonOffset = -7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .categoryName =  _("{JPN}おなが"),
        .height = 8,
        .weight = 115,
        .description = COMPOUND_STRING(
            "{JPN}きように うごく しっぽの さきを てのひらの\nかわりに つかっていたら はんたいに りょうてが\nぶきように なってしまった ポケモンだ。"),
        .pokemonScale = 363,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .categoryName =  _("{JPN}たね"),
        .height = 3,
        .weight = 18,
        .description = COMPOUND_STRING(
            "{JPN}からだに ためた えいようは しんかの ときまで\nとっておくため ほとんど うごこうとしない。\nなにも たべずに あさつゆ だけを のんでいる。"),
        .pokemonScale = 541,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .categoryName =  _("{JPN}うすばね"),
        .height = 12,
        .weight = 380,
        .description = COMPOUND_STRING(
            "{JPN}めだまを うごかさずに 360ど みわたせる。\nきゅうブレーキや ほうこうてんかんが とくい。\nねらった えものを すばやく おいつめていく。"),
        .pokemonScale = 274,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .categoryName =  _("{JPN}オニトンボ"),
        .height = 19,
        .weight = 515,
        .description = COMPOUND_STRING(
            "{JPN}はばたいたときの しょうげきはで\nあいての からだの うちがわに\nちめいてきな ダメージを あたえる。"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .categoryName =  _("{JPN}みずうお"),
        .height = 4,
        .weight = 85,
        .description = COMPOUND_STRING(
            "{JPN}ふだんは みずの なかで くらしているが エサを\nさがすときなど たまに ちじょうに でてくる。\nりくでは どくの ねんえきで からだを おおう。"),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .cryId = CRY_WOOPER,
        .natDexNum = NATIONAL_DEX_WOOPER,
        .categoryName =  _("{JPN}どくうお"),
        .height = 4,
        .weight = 110,
        .description = COMPOUND_STRING(
            "{JPN}なわばりあらそいに やぶれて りくで\nくらすうちに どくの ねんまくで\nからだを ほごするように かわった。"),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLODSIRE] =
    {
        ...
        .categoryName =  _("{JPN}とげうお"),
        .height = 18,
        .weight = 2230,
        .description = COMPOUND_STRING(
            "{JPN}てきに おそわれると ふとい とげを\nどうたいから つきだして はんげき。\nみをきる かくごの きけんな わざ。"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .categoryName =  _("{JPN}よなき"),
        .height = 7,
        .weight = 10,
        .description = COMPOUND_STRING(
            "{JPN}すすりなく ような なきごえで こわがらせる。\nあいての こわがる こころを あかい たまで\nきゅうしゅうして えいように している らしい。"),
        .pokemonScale = 407,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .categoryName =  _("{JPN}ほがらか"),
        .height = 6,
        .weight = 140,
        .description = COMPOUND_STRING(
            "{JPN}あまい くだものが だいこうぶつ。\nみみの ような うでで きように つみとる。\nかおりに さそわれて かじゅえんに あつまる。"),
        .pokemonScale = 484,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .categoryName =  _("{JPN}がまん"),
        .height = 13,
        .weight = 285,
        .description = COMPOUND_STRING(
            "{JPN}ふだんは おとなしいが くろい しっぽを\nこうげきされると もうれつに はんげきする。\nどうくつの すみかで ひぐれを まつ。"),
        .pokemonScale = 274,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .categoryName =  _("{JPN}くびなが"),
        .height = 15,
        .weight = 415,
        .description = COMPOUND_STRING(
            "{JPN}くさや きのめを たべる そうしょくせい。\nキリンリキが くさを たべている ときは\nシッポも もぐもぐ なにかを たべる しぐさ。"),
        .pokemonScale = 281,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .categoryName =  _("{JPN}つちへび"),
        .height = 15,
        .weight = 140,
        .description = COMPOUND_STRING(
            "{JPN}ドリルの シッポを つかって うしろむきに\nじめんを ほりすすみ ふくざつな かたちの\nすあなを ちちゅう ふかくに つくる ポケモン。"),
        .pokemonScale = 316,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .categoryName =  _("{JPN}とびさそり"),
        .height = 11,
        .weight = 648,
        .description = COMPOUND_STRING(
            "{JPN}おとを たてず すべる ように かっくうする。\nりょううでの おおきな ツメと あしの ツメで\nえものの かおに しがみつき どくばりを さす。"),
        .pokemonScale = 350,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .categoryName =  _("{JPN}キバさそり"),
        .height = 20,
        .weight = 425,
        .description = COMPOUND_STRING(
            "{JPN}しっぽで きのえだに ぶらさがり\nえものを かんさつする。すきを\nみて じょうくうから おそいかかる。"),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .categoryName =  _("{JPN}ようせい"),
        .height = 6,
        .weight = 78,
        .description = COMPOUND_STRING(
            "{JPN}キバを むきだして こわい かおを すれば\nちいさな ポケモンなら おびえて にげだす。\nにげられた ブルーは ちょっと さみしそう。"),
        .pokemonScale = 465,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
            "{JPN}はりより どく ちらす やっかいものゆえ\nりょうしには いみきらわれし そんざい。\nほかのちほうでは ことなるすがたで せいそくす。"),
        .pokemonScale = 430,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OVERQWIL] =
    {
        ...
        .categoryName =  _("{JPN}けんざん"),
        .height = 25,
        .weight = 605,
        .description = COMPOUND_STRING(
            "{JPN}やりのごとき はりと きょうぼうなる きしつにて\nかいきの いみょうを もつ ポケモン。\nどくを すすりて おのれの かてとす。"),
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .categoryName =  _("{JPN}はっこう"),
        .height = 6,
        .weight = 205,
        .description = COMPOUND_STRING(
            "{JPN}いわの したで こうらの なかに たくわえた\nきのみを たべながら みを ひそめている。\nたいえきと まざり きのみは ジュースに なる。"),
        .pokemonScale = 485,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .categoryName =  _("{JPN}1ぽんヅノ"),
        .height = 15,
        .weight = 540,
        .description = COMPOUND_STRING(
            "{JPN}あまい じゅえきを もとめて もりに あつまる。\nてつの ように かたい ひふに おおわれている。\nじまんの ツノで あいてを なげとばす。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .weight = 625,
        .description = COMPOUND_STRING(
            "{JPN}2ほんの ツノで はさみこみ じぶんの\nたいじゅうの 500ばいの おもさの ものも\nもちあげられるのだ。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .categoryName =  _("{JPN}かぎづめ"),
        .height = 9,
        .weight = 280,
        .description = COMPOUND_STRING(
            "{JPN}てあしの カギヅメを つきたてて きを のぼる。\nおやの いない すきを ねらって きの うえに\nある す から タマゴを ぬすんで たべる。"),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
            "{JPN}かぎづめ たくましく だんがいぜっぺきを とうはするに\nゆうりな けいじょう。 せんたんより どくえき したたり\nえもの とらえしとき しんけいを おかす。"),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .categoryName =  _("{JPN}クライミング"),
        .height = 13,
        .weight = 430,
        .description = COMPOUND_STRING(
            "{JPN}たしゅ あっとうする しんたいのうりょくと もうどく ゆうし\nかんれいなる こうちにおいては てきなし。\nむれなさず たんどくをよしとする せいしつ。"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .categoryName =  _("{JPN}こぐま"),
        .height = 6,
        .weight = 88,
        .description = COMPOUND_STRING(
            "{JPN}ハチミツの しみこんだ てのひらを なめている。\nヒメグマの ハチミツは くだものと スピアーの\nあつめた かふんが ブレンドされて つくられる。"),
        .pokemonScale = 455,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .categoryName =  _("{JPN}とうみん"),
        .height = 18,
        .weight = 1258,
        .description = COMPOUND_STRING(
            "{JPN}もりの なかには リングマが エサあつめを する\nたいぼくや おがわが あちこちに あると いう。\nまいにち エサを あつめて もりを あるく。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .categoryName =  _("{JPN}でいたん"),
        .height = 24,
        .weight = 2900,
        .description = COMPOUND_STRING(
            "{JPN}ヒスイのちに しかれし ぬまちのつちこそ\nがんじょうなるたいくと でいたんを じざいに あつかう。\nあらたな きりょう もたらしたと こうさつす。"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .categoryName =  _("{JPN}ようがん"),
        .height = 7,
        .weight = 350,
        .description = COMPOUND_STRING(
            "{JPN}かざんちたいで くらす ポケモンの いっしゅ。\nからだが ひえると ひふが かたまってしまい\nうごけなくなるため マグマの そばで ねむる。"),
        .pokemonScale = 329,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .categoryName =  _("{JPN}いのぶた"),
        .height = 4,
        .weight = 65,
        .description = COMPOUND_STRING(
            "{JPN}じめんに はなを こすりつけて エサを さがす。\nかれくさの したに はえた キノコが こうぶつ。\nたまに おんせんを ほりあてる ことが あるよ。"),
        .pokemonScale = 324,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .categoryName =  _("{JPN}いのしし"),
        .height = 11,
        .weight = 558,
        .description = COMPOUND_STRING(
            "{JPN}こごえる さむさにも たえられる ように\nあつくて ながい けがわに おおわれている。\nこおりに うまった エサを キバで ほりだす。"),
        .pokemonScale = 306,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .categoryName =  _("{JPN}2ほんキバ"),
        .height = 25,
        .weight = 2910,
        .description = COMPOUND_STRING(
            "{JPN}こおりで できた りっぱな キバ。\nひょうがきが おわり あたたかく\nなったため かずが へってしまった。"),
        .pokemonScale = 257,
        .pokemonOffset = 6,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .categoryName =  _("{JPN}さんご"),
        .height = 6,
        .weight = 50,
        .description = COMPOUND_STRING(
            "{JPN}あたたかい みなみの うみに せいそくする。\nうみが よごれると うつくしい サンゴのえだは\nいろが くすみ ボロボロに なってしまう。"),
        .pokemonScale = 410,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .categoryName =  _("{JPN}ふんしゃ"),
        .height = 6,
        .weight = 120,
        .description = COMPOUND_STRING(
            "{JPN}のんだ みずを ふっきんを つかい いきおいよく\nふきだして そらを とぶ えものを しとめる。\nしんかが ちかづくと かわを くだっていく。"),
        .pokemonScale = 316,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .categoryName =  _("{JPN}はこびや"),
        .height = 9,
        .weight = 160,
        .description = COMPOUND_STRING(
            "{JPN}しっぽで エサを つつみ もちはこぶ ポケモン。\nデリバードに エサを わけてもらった おかげで\nエベレストを のぼりきれた ぼうけんかが いた。"),
        .pokemonScale = 293,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .categoryName =  _("{JPN}カイト"),
        .height = 10,
        .weight = 650,
        .description = COMPOUND_STRING(
            "{JPN}とくちょうてきな せなかの もようは\nすむ ちいきによって ちがうことが\nがくしゃの けんきゅうで わかった。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .categoryName =  _("{JPN}よろいどり"),
        .height = 17,
        .weight = 505,
        .description = COMPOUND_STRING(
            "{JPN}はがねの からだと ハネを もつ ポケモン。\nむかしの ひとは ぬけおちた ハネを つかって\nかたなや ほうちょうを つくっていた。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 271,
        .trainerOffset = 1,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .categoryName =  _("{JPN}ダーク"),
        .height = 6,
        .weight = 108,
        .description = COMPOUND_STRING(
            "{JPN}さまざまな なきごえを つかいわけ なかまと\nれんらくを とりあい えものを おいこんでいく。\nチームワークの みごとさは ポケモンずいいち。"),
        .pokemonScale = 393,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .categoryName =  _("{JPN}ながばな"),
        .height = 5,
        .weight = 335,
        .description = COMPOUND_STRING(
            "{JPN}ゴマゾウの おおきな みみは うちわの かわり。\nあつくなると ぱたぱた あおいで すずむ。\nこどもでも ちからは とても つよい。"),
        .pokemonScale = 465,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .categoryName =  _("{JPN}よろい"),
        .height = 11,
        .weight = 1200,
        .description = COMPOUND_STRING(
            "{JPN}ダンプカーを らくらく ひっぱる ちからもち。\nいわの ように かたくなった ひふは\nすこしの こうげきでは キズも つかない。"),
        .pokemonScale = 313,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .categoryName =  _("{JPN}おおツノ"),
        .height = 14,
        .weight = 712,
        .description = COMPOUND_STRING(
            "{JPN}みごとな かたちの ツノは びじゅつひん として\nたかく うれた ために ぜつめつ すんぜんまで\nらんかくされた ことのある ポケモン。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .weight = 951,
        .description = COMPOUND_STRING(
            "{JPN}めにみえぬ かべを つくりしとき くろきたま\nあやしく かがやきたり。 ぬけおちし ひげは\nあたたかく ふゆごろもの げんりょうに ちょうほうす。"),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .categoryName =  _("{JPN}えかき"),
        .height = 12,
        .weight = 580,
        .description = COMPOUND_STRING(
            "{JPN}しっぽの さきから にじみでる たいえきで\nなわばりの まわりに じぶんの マークを かく。\n5000 しゅるいの マークが みつかっている。"),
        .pokemonScale = 287,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .categoryName =  _("{JPN}ちちうし"),
        .height = 12,
        .weight = 755,
        .description = COMPOUND_STRING(
            "{JPN}まいにち 20リットルの ミルクを だす。\nあまい ミルクは おとなも こどもも だいすき。\nにがてな ひとは ヨーグルトにして たべている。"),
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .categoryName =  _("{JPN}いかずち"),
        .height = 19,
        .weight = 1780,
        .description = COMPOUND_STRING(
            "{JPN}かみなりの スピードを やどした ポケモン。\nその とおぼえは かみなりが おちた ときの\nように くうきを ふるわせ だいちを ゆるがす。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .categoryName =  _("{JPN}オーロラ"),
        .height = 20,
        .weight = 1870,
        .description = COMPOUND_STRING(
            "{JPN}わきみずの やさしさを やどした ポケモン。\nすべる ような みのこなしで だいちを はしり\nにごった みずを きよめる ちからを もつ。"),
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .categoryName =  _("{JPN}いわはだ"),
        .height = 6,
        .weight = 720,
        .description = COMPOUND_STRING(
            "{JPN}ちちゅう ふかくで うまれる ヨーギラスは\nつちを たべつくして ちじょうへ でないと\nおやの かおを みる ことが できないのだ。"),
        .pokemonScale = 472,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .categoryName =  _("{JPN}だんがん"),
        .height = 12,
        .weight = 1520,
        .description = COMPOUND_STRING(
            "{JPN}たいないで つくりだした ガスを あっしゅくして\nいきおいよく ふんしゃする ことで とんでいく。\nこうてつに ぶつかっても へいきな ボディだ。"),
        .pokemonScale = 292,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .categoryName =  _("{JPN}せんすい"),
        .height = 52,
        .weight = 2160,
        .description = COMPOUND_STRING(
            "{JPN}つばさを かるく はばたかせた だけで みんかを\nふきとばす はかいりょくを もっている ために\nかいていで ひとしれず くらす ように なった。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .categoryName =  _("{JPN}にじいろ"),
        .height = 38,
        .weight = 1990,
        .description = COMPOUND_STRING(
            "{JPN}ひかりの あたる かくどに よって なないろに\nかがやく ハネは しあわせを もたらすと いう。\nにじの ふもとに すむと いわれている。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .categoryName =  _("{JPN}ときわたり"),
        .height = 6,
        .weight = 50,
        .description = COMPOUND_STRING(
            "{JPN}ときを こえ みらいから やってきた ポケモン。\nセレビィが すがたを あらわす かぎり あかるい\nみらいが まっていると かんがえられている。"),
        .pokemonScale = 393,
        .pokemonOffset = -10,
        .trainerScale = 256,
        .trainerOffset = 0,
