...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .categoryName = _("{JPN}わかば"),
        .height = 4,
        .weight = 102,
        .description = COMPOUND_STRING(
            "{JPN}つちで できた せなかの こうらを\nさわって ほどよく しめっていたなら\nその ナエトルは とても げんきだ。"),
        .pokemonScale = 491,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GROTLE] =
    {
        ...
        .categoryName = _("{JPN}こだち"),
        .height = 11,
        .weight = 970,
        .description = COMPOUND_STRING(
            "{JPN}きれいな みずが わきでる ばしょを\nしっていて なかまの ポケモンを\nせなかに のせて そこまで はこぶ。"),
        .pokemonScale = 320,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .categoryName = _("{JPN}たいりく"),
        .height = 22,
        .weight = 3100,
        .description = COMPOUND_STRING(
            "{JPN}ドダイトスの せなかで うまれて\nドダイトスの せなかで いっしょうを\nまっとうする ポケモンが いる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [SPECIES_STARLY] =
    {
        ...
        .categoryName = _("{JPN}むくどり"),
        .height = 3,
        .weight = 20,
        .description = COMPOUND_STRING(
            "{JPN}むれを つくることで 1ぴきでの\nよわさを カバーしあっているが\nむれが おおきくなると もめだす。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .categoryName = _("{JPN}もうきん"),
        .height = 12,
        .weight = 249,
        .description = COMPOUND_STRING(
            "{JPN}じぶんの からだを きずつこうとも\nこうげきを やめなくなった。\nとさかの かたちを きにしている。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .categoryName = _("{JPN}こおろぎ"),
        .height = 3,
        .weight = 22,
        .description = COMPOUND_STRING(
            "{JPN}あしが みじかく こけそうに なるたび\nたかい しょっかくが こすれあって\nもっきんの ような おとが ひびく。"),
        .pokemonScale = 530,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .categoryName = _("{JPN}せんこう"),
        .height = 5,
        .weight = 95,
        .description = COMPOUND_STRING(
            "{JPN}からだを うごかす たびに きんにくが\nのびちぢみして でんきが うまれる。\nピンチになると からだが かがやく。"),
        .pokemonScale = 432,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .categoryName = _("{JPN}でんこう"),
        .height = 9,
        .weight = 305,
        .description = COMPOUND_STRING(
            "{JPN}するどい ツメの さきには つよい\nでんきが ながれており ほんのすこし\nかすだけで あいてを きぜつ させる。"),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .categoryName = _("{JPN}がんこう"),
        .height = 14,
        .weight = 420,
        .description = COMPOUND_STRING(
            "{JPN}かべの むこうも みえる ちからで\nにげた えものを おいつめる ほかにも\nまいごの こどもを さがしたりする。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .categoryName = _("{JPN}ずつき"),
        .height = 9,
        .weight = 315,
        .description = COMPOUND_STRING(
            "{JPN}およそ 1おくねんまえの ポケモン。\nジャングルで うまれそだち じゃまな\nじゅもくは ずつきで へしおった。"),
        .pokemonScale = 338,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .categoryName = _("{JPN}シールド"),
        .height = 5,
        .weight = 570,
        .description = COMPOUND_STRING(
            "{JPN}ばつぐんの ぼうぎょりょくを もつ。\nそのため とくに あらそうこともなく\nくさや きのみを たべて すごす。"),
        .pokemonScale = 432,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .categoryName = _("{JPN}みのむし"),
        .height = 2,
        .weight = 34,
        .description = COMPOUND_STRING(
            "{JPN}つめたい こがらしを ふせぐため\nこえだや おちばを ざいりょうに\nミノを つくり からを おおう。"),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .categoryName = _("{JPN}はちのこ"),
        .height = 3,
        .weight = 55,
        .description = COMPOUND_STRING(
            "{JPN}うまれた ときから 3びき いっしょ。\nビークインに よろこんで もらうため\nいつも はなのミツを あつめている。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .categoryName = _("{JPN}はちのす"),
        .height = 12,
        .weight = 385,
        .description = COMPOUND_STRING(
            "{JPN}さまざまな フェロモンを だして\nどうたいに いる こどもたちを\nじざいに あやつり てきと たたかう。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .categoryName = _("{JPN}でんきリス"),
        .height = 4,
        .weight = 39,
        .description = COMPOUND_STRING(
            "{JPN}たまった でんきを わけあたえようと\nほほぶくろを こすりあわせる\nパチリスを みかけることも ある。"),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .categoryName = _("{JPN}うみイタチ"),
        .height = 7,
        .weight = 295,
        .description = COMPOUND_STRING(
            "{JPN}しっぽを スクリューのように まわし\nすいちゅうを およぐだけでなく\nまとわりつく かいそうも きれる。"),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .categoryName = _("{JPN}ウミウシ"),
        .height = 3,
        .weight = 63,
        .description = COMPOUND_STRING(
            "{JPN}やわらかい からだを つよく おすと\nむらさき いろの なぞの えきたいが\nにじみでる ので ようちゅうい。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .categoryName = _("{JPN}ききゅう"),
        .height = 12,
        .weight = 150,
        .description = COMPOUND_STRING(
            "{JPN}ゆうぐれ むれになって おおぞらを\nかぜに ながされていくが きづくと\nいつのまにか きえて しまっている。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .categoryName = _("{JPN}ねこかぶり"),
        .height = 5,
        .weight = 39,
        .description = COMPOUND_STRING(
            "{JPN}トレーナーが エサを くれないと\nはなのあなに ツメをひっかける\nひどい いちめんを ひめている。"),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .categoryName = _("{JPN}とらねこ"),
        .height = 10,
        .weight = 438,
        .description = COMPOUND_STRING(
            "{JPN}どうたいを しっぽで しばりつけて\nじぶんを おおきく みせている。\nめがあうと いつまでも にらみあう。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .categoryName = _("{JPN}スカンク"),
        .height = 4,
        .weight = 192,
        .description = COMPOUND_STRING(
            "{JPN}おしりから とばす くさい しるの\nにおいは はんけい2キロに ひろがり\nまわりの ポケモンは いなくなる。"),
        .pokemonScale = 491,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .categoryName = _("{JPN}おんぷ"),
        .height = 5,
        .weight = 19,
        .description = COMPOUND_STRING(
            "{JPN}ベロは にんげんのものに そっくり。\nそのため にんげんの はなすことばを\nじょうずに まねることが できる。"),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .categoryName = _("{JPN}ふういん"),
        .height = 10,
        .weight = 1080,
        .description = COMPOUND_STRING(
            "{JPN}いつも わるさばかり していたら\nふしぎな じゅつで ほんたいを\nかなめいしに しばりつけられた。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .categoryName = _("{JPN}りくザメ"),
        .height = 7,
        .weight = 205,
        .description = COMPOUND_STRING(
            "{JPN}おおぐちを つかった こうげきは\nいりょく じゅうぶんだが まだ\nうまく たたかえず じぶんも きずつく。"),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GABITE] =
    {
        ...
        .categoryName = _("{JPN}ほらあな"),
        .height = 14,
        .weight = 560,
        .description = COMPOUND_STRING(
            "{JPN}ひかりかがやく ものが だいすきで\nどうくつの なかで みつけた\nたからを じぶんのすに ためこむ。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        .categoryName = _("{JPN}マッハ"),
        .height = 19,
        .weight = 950,
        .description = COMPOUND_STRING(
            "{JPN}こうそくで かけぬけると つばさは\nくうきの やいばを うみだし\nまわりの きは せつだん されている。"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .categoryName = _("{JPN}はどう"),
        .height = 12,
        .weight = 540,
        .description = COMPOUND_STRING(
            "{JPN}きたえられた ルカリオは はどうを\nつかい 1キロさきに だれがいるのか\nどんな きもちか さえも わかる。"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .categoryName = _("{JPN}カバ"),
        .height = 8,
        .weight = 495,
        .description = COMPOUND_STRING(
            "{JPN}はなの あなを ぴたりと とじてから\nすなの なかを あるくように すすむ。\n10ぴき ていどの むれで くらす。"),
        .pokemonScale = 366,
        .pokemonOffset = 11,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .categoryName = _("{JPN}じゅうりょう"),
        .height = 20,
        .weight = 3000,
        .description = COMPOUND_STRING(
            "{JPN}いがいと おこりっぽい ポケモンで\nくちを おおきく あけることで\nまわりに つよさを アピールする。"),
        .pokemonScale = 261,
        .pokemonOffset = 2,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .categoryName = _("{JPN}さそり"),
        .height = 8,
        .weight = 120,
        .description = COMPOUND_STRING(
            "{JPN}しっぽの はさみが とじると どうじに\nはりの さきから どくが にじみだす。\n1ねん なにも たべずに たえられる。"),
        .pokemonScale = 366,
        .pokemonOffset = 12,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .categoryName = _("{JPN}ばけさそり"),
        .height = 13,
        .weight = 615,
        .description = COMPOUND_STRING(
            "{JPN}もうどくを つかわなくても じまんの\nちからで あいてを バラバラにする\nがんじょうな からだの もちぬし。"),
        .pokemonScale = 272,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .categoryName = _("{JPN}どくづき"),
        .height = 7,
        .weight = 230,
        .description = COMPOUND_STRING(
            "{JPN}せいせいどうどうと たたかうことは\nすくないが それも いきのびるため。\nマスコットとして にんきが たかい。"),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .categoryName = _("{JPN}むしとり"),
        .height = 14,
        .weight = 270,
        .description = COMPOUND_STRING(
            "{JPN}しっちたいに はえる きにまきつき\nあまいかおりの だえきで えものを\nおびきよせては ひとくちで たべる。"),
        .pokemonScale = 265,
        .pokemonOffset = 2,
        .trainerScale = 262,
        .trainerOffset = 0,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .categoryName = _("{JPN}はねうお"),
        .height = 4,
        .weight = 70,
        .description = COMPOUND_STRING(
            "{JPN}からだの よこがわにある ラインは\nたいようの ひかりを ためておける。\nよるに なると あざやかに かがやく。"),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .categoryName = _("{JPN}じゅひょう"),
        .height = 10,
        .weight = 505,
        .description = COMPOUND_STRING(
            "{JPN}にんげんに きょうみが あるのか\nゆきやまで あしあを みるけると\nそのまわりに あつまってくる。"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_ABOMASNOW_MEGA] =
    {
        ...
        .weight = 1850,
        .description = COMPOUND_STRING(
            "{JPN}つぼみから りっぱに せいちょうした\nせなかの こおりばしらが マイナス30どの\nもうふぶきを まきおこす。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .categoryName = _("{JPN}プラズマ"),
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING(
            "{JPN}でんきのような からだは いちぶの\nきかいに はいりこむことが できる。\nそして そのからだで いたずらする。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .categoryName = _("{JPN}じかん"),
        .height = 54,
        .weight = 6830,
        .description = COMPOUND_STRING(
            "{JPN}ディアルガの しんぞうが うごくと\nじかんは ながれていくと されている。\nシンオウの でんせつ ポケモン。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_DIALGA_ORIGIN] =
    {
        ...
        .weight = 8500,
        .description = COMPOUND_STRING(
            "{JPN}こうみょう フォルムチェンジの ひきがね。\nそうぞうしんに こくじするすがたこそ しんなりと\nおもわざるを えぬほどの ごうりき はっきす。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .categoryName = _("{JPN}くうかん"),
        .height = 42,
        .weight = 3360,
        .description = COMPOUND_STRING(
            "{JPN}パルキアが こきゅうを するたびに\nくうかんは あいていすると される。\nシンオウの でんせつの ポケモン。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
        .trainerOffset = 16,
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        .weight = 6600,
        .description = COMPOUND_STRING(
            "{JPN}あまかけるすがた ばんぶつを つくりし\nそんざいを そうきす。 すがたを もすこと\nすなわち そのちからを わがものとするすべと すいさつ。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 650,
        .trainerOffset = 16,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .categoryName = _("{JPN}かこう"),
        .height = 17,
        .weight = 4300,
        .description = COMPOUND_STRING(
            "{JPN}がんじょうな はがねの からだだが\nじぶんが はっする こうねつの ため\nところどころ とけてしまっている。"),
        .pokemonScale = 259,
        .pokemonOffset = 1,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .categoryName = _("{JPN}きょだい"),
        .height = 37,
        .weight = 4200,
        .description = COMPOUND_STRING(
            "{JPN}とくしゅな ひょうざんや がんせき\nマグマから じぶんの すがたに にた\nポケモンを つくったと いわれる。"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .categoryName = _("{JPN}はんこつ"),
        .height = 45,
        .weight = 7500,
        .description = COMPOUND_STRING(
            "{JPN}このよの うらがわに ある せかいに\nすんでいると いわれる ポケモン。\nこだいの はかばに あらわれる。"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 614,
        .trainerOffset = 13,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .categoryName = _("{JPN}かいよう"),
        .height = 4,
        .weight = 31,
        .description = COMPOUND_STRING(
            "{JPN}あたたかい うみを ただよっている。\nどんな とおく ながされても\nうまれた ばしょに かならずもどる。"),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .categoryName = _("{JPN}かいゆう"),
        .height = 3,
        .weight = 14,
        .description = COMPOUND_STRING(
            "{JPN}うまれたときから そなわっている\nふしぎな ちからを つかうと どんな\nポケモンとも こころが かよいあう。"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .categoryName = _("{JPN}あんこく"),
        .height = 15,
        .weight = 505,
        .description = COMPOUND_STRING(
            "{JPN}じぶんを まもるために まわりの\nひとや ポケモンに あくむをみせるが\nダークライに わるぎは ないのだ。"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .categoryName = _("{JPN}かんしゃ"),
        .height = 2,
        .weight = 21,
        .description = COMPOUND_STRING(
            "{JPN}はなばたけの なかで くらしているが\nからだを まるめると はなのように\nみえるため だれも きづかないのだ。"),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
