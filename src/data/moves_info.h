...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_THUNDER_WAVE] =
    {
        ...
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = B_UPDATED_MOVE_DATA >= 100,
        .pp = 20,
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        ...
        .description = COMPOUND_STRING("{JPN}じぶんひんし\nさわらない"),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = B_UPDATED_MOVE_DATA >= 80,
        .pp = 10,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
