...
enum __attribute__((packed)) Item
{
    ...
    ITEM_CHILAN_BERRY = 565,
    ITEM_LIECHI_BERRY = 566,
    ITEM_GANLON_BERRY = 567,
    ITEM_SALAC_BERRY = 568,
    ITEM_PETAYA_BERRY = 569,
    ITEM_APICOT_BERRY = 570,
    ITEM_LANSAT_BERRY = 571,
    ITEM_STARF_BERRY = 572,
    ITEM_ENIGMA_BERRY = 573,
    ITEM_MICLE_BERRY = 574,
    ITEM_CUSTAP_BERRY = 575,
    ITEM_JABOCA_BERRY = 576,
    ITEM_ROWAP_BERRY = 577,
    ITEM_ROSELI_BERRY = 578,
    ITEM_KEE_BERRY = 579,
