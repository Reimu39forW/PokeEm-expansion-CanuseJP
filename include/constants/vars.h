...
// Compatibility aliases for dormant FRLG-derived helper code that is still
// compiled in the Emerald build. These preserve the original numeric IDs
// without keeping the removed FRLG constants header.
...
// Compatibility constants retained from the removed FRLG vars header.
