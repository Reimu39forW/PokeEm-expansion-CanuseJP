...
enum BattleIntroStates
{
    ...
    BATTLE_INTRO_STATE_FRONTIER_NICKNAME_SEND_OUT_TEXT,
    BATTLE_INTRO_STATE_WAIT_FOR_FRONTIER_NICKNAME_SEND_OUT_TEXT,
    BATTLE_INTRO_STATE_FRONTIER_NICKNAME_SEND_OUT_TEXT_2,
    BATTLE_INTRO_STATE_WAIT_FOR_FRONTIER_NICKNAME_SEND_OUT_TEXT_2,
